...
bool TWidget::IsParentOf(TWidget& child) {
  return widget_is_parent_of(((const widget_t*)(this->nativeObj)),
                             ((const widget_t*)(child.nativeObj)));
}

bool TWidget::IsDirectParentOf(TWidget& child) {
  return widget_is_direct_parent_of(((const widget_t*)(this->nativeObj)),
                                    ((const widget_t*)(child.nativeObj)));
}
...
TWidget TSerialWidget::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h) {
  return TSerialWidget(
      (widget_t*)(serial_widget_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
}
...
TWidget TTimerWidget::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h) {
  return TTimerWidget(
      (widget_t*)(timer_widget_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
}
...
TWidget TCheckButton::CreateEx(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h, const char* type,
                               bool radio) {
  return TCheckButton((
      widget_t*)(check_button_create_ex(((widget_t*)(parent.nativeObj)), x, y, w, h, type, radio)));
}
...
ret_t TNativeWindow::SetOrientation(lcd_orientation_t old_orientation,
                                    lcd_orientation_t new_orientation) {
  return native_window_set_orientation(((native_window_t*)(this->nativeObj)), old_orientation,
                                       new_orientation);
}
...
ret_t TEditEx::SetSuggestWords(TObject& suggest_words) {
  return edit_ex_set_suggest_words(((widget_t*)(this->nativeObj)),
                                   ((object_t*)(suggest_words.nativeObj)));
}
...
TWidget TListItemSeperator::Create(TWidget& parent, xy_t x, xy_t y, wh_t w, wh_t h) {
  return TListItemSeperator(
      (widget_t*)(list_item_seperator_create(((widget_t*)(parent.nativeObj)), x, y, w, h)));
}
...
TNamedValueHash TNamedValueHash::Clone() {
  return TNamedValueHash(
      (value_t*)(named_value_hash_clone(((named_value_hash_t*)(this->nativeObj)))));
}
...
ret_t TObjectHash::SetNameCaseInsensitive(bool name_case_insensitive) {
  return object_hash_set_name_case_insensitive(((object_t*)(this->nativeObj)),
                                               name_case_insensitive);
}
